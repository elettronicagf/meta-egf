DESCRIPTION = "SBC Image - Adds Qt5"
LICENSE = "MIT"

require recipes-egf/images/sbc-image-gui.bb
...
QT5_IMAGE_INSTALL_append = " qtquickcontrols2 qtquick1 qtquickcontrols "
...
export IMAGE_BASENAME = "${MACHINE}-image-gui-qt5-${GF_YOCTO_ROOTFS_VERSION}"
