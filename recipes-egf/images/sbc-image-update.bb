...
PACKAGE_INSTALL = "initramfs-boot busybox udev base-passwd udev-extraconf \
				  dosfstools e2fsprogs openssl tar bzip2 egf-ota \
				  mtd-utils mtd-utils-ubifs unzip nano util-linux egf-gpio "
...
export IMAGE_BASENAME = "${MACHINE}-${GF_YOCTO_ROOTFS_LIVE_VERSION}-live"
